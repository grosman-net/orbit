...
echo "OK Repository added: ${SOURCES_FILE}"
echo ""
...
echo "WARNING: Could not fetch latest version, using fallback: 1.2.0"
        LATEST_VERSION="1.2.0"
    else
echo "OK Latest version: $LATEST_VERSION"
    fi
echo ""
...
echo "OK Package downloaded: ${RPM_FILE}"
echo ""
